...
log close
log using paagrd02, replace text


/***************************************************************************************************/
/* Regression using variable group "A2"                                                             */
...
mlogit where94 sex84 age84 pcmig84 elct84 person84 ginicult hdjute84 gcop3 gnp73b3 gfor76b3, basecategory(1) robust cluster (vill84) 
...
mlogit migstat male age pctmigs electric totpop ginicult hdjute84 gcop3 gnp73b3 gfor73b3, basecategory(1) robust cluster (vill84) 

           
/*1976*/

mlogit migstat male age pctmigs electric totpop ginicult hdjute84 gcop3 gnp76b3 gfor76b3, basecategory(1) robust cluster (vill84) 
