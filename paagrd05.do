...
log close
log using paagrd05, replace text


/***************************************************************************************************/
/* Regression using variable group "C2"                                                             */
...
mlogit migstat male age pctmigs electric totpop ginicult hdjute84 g3bppvil g3b73nf g3b73af, basecategory(1) robust cluster (vill84) 

           
/*1976*/

mlogit migstat male age pctmigs electric totpop ginicult hdjute84 g3bppvil g3b76nf g3b76af, basecategory(1) robust cluster (vill84) 
