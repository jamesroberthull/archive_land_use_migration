...
log close
log using paagrd06, replace text


/***************************************************************************************************/
/* Regression using variable group "D1"                                                             */
...
mlogit where94 sex84 age84 pcmig84 elct84 person84 ginicult hdjute84 gcob3 g3n73f05 g3p73f05, basecategory(1) robust cluster (vill84) 

           
/*1976*/

mlogit where94 sex84 age84 pcmig84 elct84 person84 ginicult hdjute84 gcob3 g3n76f05 g3p76f05, basecategory(1) robust cluster (vill84) 
...
mlogit migstat male age pctmigs electric totpop ginicult hdjute84 gcob3 g3n73f05 g3p73f05, basecategory(1) robust cluster (vill84) 

           
/*1976*/

mlogit migstat male age pctmigs electric totpop ginicult hdjute84 gcob3 g3n76f05 g3p76f05, basecategory(1) robust cluster (vill84) 
