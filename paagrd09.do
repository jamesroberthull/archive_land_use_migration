...
log close
log using paagrd09, replace text


/***************************************************************************************************/
/* Regression using variable group "E2"                                                             */
...
mlogit where94 sex84 age84 pcmig84 elct84 person84 ginicult hdjute84 gcop3 g3n73f96 g3p73f96, basecategory(1) robust cluster (vill84) 

           
/*1976*/

mlogit where94 sex84 age84 pcmig84 elct84 person84 ginicult hdjute84 gcop3 g3n76f96 g3p76f96, basecategory(1) robust cluster (vill84) 
...
mlogit migstat male age pctmigs electric totpop ginicult hdjute84 gcop3 g3n73f96 g3p73f96, basecategory(1) robust cluster (vill84) 

           
/*1976*/

mlogit migstat male age pctmigs electric totpop ginicult hdjute84 gcop3 g3n76f96 g3p76f96, basecategory(1) robust cluster (vill84) 
